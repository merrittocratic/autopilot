...
the same tweet bundle to produce 3-5 **Today's Takes** (X-native
original-post ideas with a sharp angle, evidence hook, and suggested
format) and sends them as a separate Telegram message. If yesterday's
